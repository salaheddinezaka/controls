...
const CustomDropDown = ({
  ...
  return (
    <div class="loan__purpose--DD dropdown__column">
      <label for="loanPurpose">{label}</label>
      <div id="loanPurpose">
        ...
        >
          <span class="dropdown__value">{selectedOption.text}</span>
        </div>
      </div>
      {isOpen && (
        <ul class="dropdown__options" id="purpose__options">
          {options.map((option) => (
            <li
