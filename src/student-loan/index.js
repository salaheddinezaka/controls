  ...
  <div class="scores__modal" style="display: block; top: 50px; opacity: 1;">
    ...
    <div class="modal__info">
      ...
      <div class="modal__form">
        ...
        <button class="loan__button" onclick="studentLoan.handleModalSubmit()">FIND LOANS</button>
      </div>
    </div>
  </div>`
...
function createSearchInput() {
  document.getElementById('search-schools-control').innerHTML = `
    ...
    <div class="control__form">
      ...
      <button class="search__button" onclick="studentLoan.handleSearchSubmit()">FIND LOANS</button>
    </div>
  </div>
  `
}
